...
public class lvmonkho extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(lvmonkho.this, ActivityMonKho.class);
    ...
    public void AnhXa()
    {
        l = (ListView) findViewById(R.id.lvmonkho);
        arr = new ArrayList<>();
        monKhoAdapter = new MonAnAdapter(this, R.layout.activity_dong, arr);
        l.setAdapter(monKhoAdapter);
    }
    public void getDataFromSQLite()
    {
        database = CheckConnection.initDatabase(this,DATABASE_NAME);
        Cursor cs = database.rawQuery("SELECT * FROM MonAn WHERE idLoaiMonAn = 3", null);
        arr.clear();
